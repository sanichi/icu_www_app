...
describe SeasonTicket do
  context "decode a ticket" do
    it "should result in correct ICU ID and expiry date", if: SeasonTicket.standard_config? do
  ...
  context "encoding an ID and date" do
    it "should result in a correct ticket", if: SeasonTicket.standard_config? do
